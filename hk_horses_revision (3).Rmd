...
Here, we are cleaning our data to NULL out any mostly empty columns that will be insignificant in our analysis. We also imputed certain columns that we found important, but had a lot of NA values. To do this, we took the mean of each column, and if a row had an NA, substituted it with the mean value.
...
ggplot(hk, aes(x=horse_age, y=place_odds)) + 
    ...
    theme_ipsum() + ggtitle("Relationship between horse age \n and pre-race place odds")+xlab("Horse age")+ylab("Pre-race place odds")+ theme(plot.title = element_text(color="#69b3a2",size = 14,face = "bold.italic",hjust = 0.5),axis.title.x = element_text(color = "#69b3a2",size=12,face="bold.italic",hjust = 0.5),axis.title.y = element_text(color = "#69b3a2",size=12,face="bold.italic",hjust = 0.5) )
```
...
ggplot(hk, aes(x=result, y=place_odds)) + 
    ...
    theme_ipsum() + ggtitle("Relationship between overall result \n and pre-race place odds")+xlab("Result")+ylab("Pre-race place odds")+ theme(plot.title = element_text(color="#69b3a2",size = 14,face = "bold.italic",hjust = 0.5),axis.title.x = element_text(color = "#69b3a2",size=12,face="bold.italic",hjust = 0.5),axis.title.y = element_text(color = "#69b3a2",size=12,face="bold.italic",hjust = 0.6))
```
...
ggplot(hk, aes(x=draw, y=result)) + 
    ...
    theme_ipsum()+ggtitle("Relationship between draw and overall result")+xlab("Draw")+ylab("Result")+ theme(plot.title = element_text(color="#69b3a2",size = 14,face = "bold.italic",hjust = 0.5),axis.title.x = element_text(color = "#69b3a2",size=12,face="bold.italic",hjust = 0.5),axis.title.y = element_text(color = "#69b3a2",size=12,face="bold.italic",hjust = 0.5))
```
...
ggplot(hk, aes(x=behind_sec2, y=result)) + 
    ...
    theme_ipsum()+ggtitle("Relationship between time behind \n the leader and overall result")+xlab("Time behind the leader (sec)")+ylab("Result")+ theme(plot.title = element_text(color="#69b3a2",size = 14,face = "bold.italic",hjust = 0.5),axis.title.x = element_text(color = "#69b3a2",size=12,face="bold.italic",hjust = 0.5),axis.title.y = element_text(color = "#69b3a2",size=12,face="bold.italic",hjust = 0.5))
```
